...
start_button = tk.Button(text='start', height=1, width=2, font=('Arial', 15), command=start)
start_button.pack(side=tk.LEFT)
pause_button = tk.Button(text='pause', height=1, width=2, font=('Arial', 15), command=pause)
pause_button.pack(side=tk.LEFT)
reset_button = tk.Button(text='reset', height=1, width=2, font=('Arial', 15), command=reset)
reset_button.pack(side=tk.LEFT)
quit_button = tk.Button(text='quit', height=1, width=2, font=('Arial', 15), command=root.quit)
